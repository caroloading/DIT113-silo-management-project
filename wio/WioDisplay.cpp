...
void WioDisplay::DisplayMeasurement(const char* preValue, const char* postValue, double measurement)
{
    char* measurementBuffer = new char[100];
    std::sprintf(measurementBuffer, "%s: %.2f%s", preValue, measurement, postValue);
